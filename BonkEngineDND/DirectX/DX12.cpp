...
bool bAllTraps = false;
bool bFlameSpout = false;
bool bFloorSpikes = false;
bool bHuntingTrap = false;
bool bPushingBlock = false;
bool bSpiderWeb = false;
bool bStickyTar = false;
bool bThornyBramble = false;
bool bTrackAxe = false;
bool bWallSpike = false;
ImColor cFlameSpout = { 0, 44, 255, 255 };
ImColor cFloorSpikes = { 0, 44, 255, 255 };
ImColor cHuntingTrap = { 0, 44, 255, 255 };
ImColor cPushingBlock = { 0, 44, 255, 255 };
ImColor cSpiderWeb = { 0, 44, 255, 255 };
ImColor cStickyTar = { 0, 44, 255, 255 };
ImColor cThornyBramble = { 0, 44, 255, 255 };
ImColor cTrackAxe = { 0, 44, 255, 255 };
ImColor cWallSpike = { 0, 44, 255, 255 };
